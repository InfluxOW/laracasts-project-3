...
@section('content')
    ...
    <div class="overflow-hidden flex items-center justify-center">
        <main class="font-sans">
            ...
            <section class="bg-gray-800 pattern">
                <div class="max-w-5xl px-6 mx-auto text-center">
                    <h2 class="text-2xl font-semibold text-white">Other Projects</h2>
                                ...
                                <a href="http://influx-tweety.herokuapp.com/"
                                   class="block bg-gray-700 mt-5 rounded-md overflow-hidden transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110">
                                    <div class="py-2 px-3 text-center text-sm">
                                        ...
                                        <span class="block text-gray-500 mt-2">influx-tweety.herokuapp.com/</span>
                                    </div>
                                </a>
                            </div>
                                ...
                                <a href="http://influx-task-manager.herokuapp.com/"
                                   class="block bg-gray-700 mt-5 rounded-md overflow-hidden transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110">
                                    <div class="py-2 px-3 text-center text-sm">
                                        ...
                                        <span class="block text-gray-500 mt-2">influx-task-manager.herokuapp.com/</span>
                                    </div>
                                </a>
                            </div>
                                ...
                                <a href="http://influx-birdboard.herokuapp.com/"
                                   class="block bg-gray-700 mt-5 rounded-md overflow-hidden transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110">
                                    <div class="py-2 px-3 text-center text-sm">
                                        ...
                                        <span class="block text-gray-500 mt-2">influx-birdboard.herokuapp.com/</span>
                                    </div>
                                </a>
                            </div>
                        </div>
