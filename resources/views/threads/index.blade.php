                ...
                <div class="flex justify-between">
                    ...
                    {!! Form::open(['url' => route('threads.search'), 'method' => 'GET', 'class' => 'mb-4']) !!}
                        <div class="inline-flex items-center'">
                            {!! Form::text('threads[query]', request()->threads['query'] ?? null, ['class' => 'bg-gray-200 focus:shadow-outline border border-gray-300 bg-gray-200 p-2 rounded-lg -mr-8', 'placeholder' => 'Search...']) !!}
