<div class="p-4 lg:w-1/3">
    <div class="h-full bg-gray-200 rounded-lg overflow-hidden text-center relative border-2 border-transparent border-opacity-25 transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110">
