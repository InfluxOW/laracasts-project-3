<div class="container mx-auto">
    <div class="flex flex-wrap justify-center">
        <div class="w-full max-w-md border border-gray-300 p-4 rounded-lg">
            <div class="font-header text-center text-xl text-blue-500 mb-4 border-b border-gray-300 -m-4 p-2 bg-gray-100 rounded-lg rounded-b-none tracking-wider">
                Create a New Thread
            </div>
