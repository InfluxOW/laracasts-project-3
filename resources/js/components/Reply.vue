        ...
        <div class="flex py-2">
            ...
            <div class="w-full">
                <div class="flex justify-between items-center">
                    <div>
                        <span class="font-bold"><a :href="'/profiles/'+data.user.username" class="text-black hover:text-opacity-50" v-text="data.user.name"></a></span>
                        <span class="text-gray-700" v-text="'@'+data.user.username"></span>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            createdAt() {
                return moment(this.data.created_at).format('MMM DD, hh:mm:ss');
            }
        },
        methods: {
            update() {
