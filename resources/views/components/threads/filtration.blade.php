<div class="mb-4">
    ...
    <div class="relative">
        ...
        ['placeholder' => 'Sort by...',
        'class' => 'block appearance-none w-full border border-gray-300 text-gray-700 py-2 px-4 pr-8 rounded leading-tight focus:shadow-outline']) }}
    ...
    <div class="flex inline-flex ml-2">
        ...
        ['class' => 'border border-gray-300 text-gray-700 py-2 px-4 rounded rounded-l-none leading-tight focus:shadow-outline',
