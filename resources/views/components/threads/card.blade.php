<div class="p-4 lg:w-1/3">
    <div class="h-full bg-gray-200 rounded-lg overflow-hidden text-center relative cursor-pointer border-2 border-transparent border-opacity-25 hover:border-gray-300" onclick="window.location='{{ route('threads.show', [$thread->channel, $thread]) }}'">
